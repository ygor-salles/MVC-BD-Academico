...
class Aluno(Base):
    ...
    curso_id = Column(String(30), ForeignKey('cursos.nome'))
...
class Grade(Base):
    ...
    curso_id = Column(String(30), ForeignKey('cursos.nome', ondelete='CASCADE'), primary_key=True, unique=True)
